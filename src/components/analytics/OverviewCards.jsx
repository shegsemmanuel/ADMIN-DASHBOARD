...
const overviewData = [
    ...
    { name: "Page Views", value: "1,234,567", change: 15.5, icon: Eye },
];
  ...
  return (
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8">
       {overviewData.map((item, index) => (
        <motion.div
         key={item.name}
            className="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border-gray-700"
